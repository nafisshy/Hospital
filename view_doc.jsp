<%-- 
    Document   : view_doc
    Created on : 23-Apr-2022, 11:01:41 am
    Author     : sadiq
--%>
       ...
       <header>
        ...
        <li class=""><a href="canceladmin.jsp"><span class="glyphicon glyphicon-log-out"></span> Logout</a></li>
           ...
           System.out.println("Statement Created");
            ResultSet rs = st.executeQuery("select d_id,dname,dob,gender,qualification,dep_name,ph_no,email,address,start_at,end_at,day from doc_registration;");
    %>
