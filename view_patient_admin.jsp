<%-- 
    Document   : view_patient_admin
    Created on : 16-Jun-2022, 11:16:18 pm
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="myNavbar">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="active"><a href="view_patient_admin.jsp">Patient</a></li>
        ...
        <%
            try{
               ...
               Connection con1 = DriverManager.getConnection(url,username,password);
                ...
                ResultSet rs = st.executeQuery("select p_id,fname,lname,email,ph_no,age,gender,address,d_id from patient_rec ;");
               while(rs.next()){
        %>
            <tr>
...
<td><center><%=rs.getString("address")%></center></td>
        <td><center><%=rs.getString("d_id")%></center></td>
<td><a href="delete_patient.jsp?id=<%=rs.getString("p_id") %>"><button type="button"  class="delete">Delete</button></a></td>
