<%-- 
    Document   : ent_doclist
    Created on : 20-Apr-2022, 11:34:45 am
    Author     : S DUTTA
--%>
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li class=""><a href="cancel.jsp"><span class="glyphicon glyphicon-log-out"></span> Logout</a></li>
         ...
         <!-- Header Ends here -->
    <h3>ENT Department Doctors</h3><br>
    <%
           ...
           System.out.println("Statement Created");
            ResultSet rs = st.executeQuery("select d_id,dname,gender,ph_no,day,start_at,end_at from doc_registration where dep_name='ENT SPECIALIST'");
    %>
