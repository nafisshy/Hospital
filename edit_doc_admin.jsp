<%-- 
    Document   : edit_doc_admin
    Created on : 28-May-2022, 4:46:02 pm
...
<%@page import="java.sql.*"%> 
    ...
    <body>
        ...
        <!-- header ends here--->
                            <table border='5' align="center" width="1500">
        <tr>
            <th>Id</th>
            <th>Name</th>
...
String sql ="select d_id,dname,qualification,dep_name,ph_no,email,start_at,end_at,day from doc_registration;";
...
<tr>
           ...
           <td><a href="edit_doc_admin_form.jsp?id=<%=resultSet.getString("d_id") %>">EDIT</a></td>
        </tr>
        <%
i++;
}
